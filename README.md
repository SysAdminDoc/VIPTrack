...
| Shareable views | A share link carries the whole filter state - altitude and speed bands, airport, airline, regex, categories, ADS-B-only and capture mode - so someone opening it sees the view you were looking at |
