...
class VipTrackContracts(unittest.TestCase):
    ...
    def test_release_version_is_synchronized_across_shell_docs_and_android(self) -> None:
        ...
        readme = (ROOT / "README.md").read_text(encoding="utf-8")
        build_gradle = (ANDROID_DIR / "app" / "build.gradle").read_text(encoding="utf-8")
        self.assertIn("<title>VIPTrack v0.8.0", self.source)
        self.assertIn('class="version">v0.8.0', self.source)
        self.assertIn("version-0.8.0-blue", readme)
        self.assertIn("## [v0.8.0] - 2026-08-18", changelog)
        self.assertIn("versionName '0.8.0'", build_gradle)
        self.assertIn("versionCode 11", build_gradle)
